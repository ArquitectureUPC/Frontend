          ...
          <v-row style="
            ...
            <v-list style="background-color: transparent; width: 100%" class="text-sm-left">
              <v-list-item-avatar size="100">
                <img v-bind:src="this.urlToImageProfile" alt="Name of Us er" />
              </v-list-item-avatar>
      ...
      <v-card class="mx-auto" max-width="1000" min-height="250" style="z-index: 1; margin-top: 20px">
        <v-container>
          <v-row style="position: absolute; margin-left: 0.3%; width: 95%">
            <v-col cols="3">
              <v-text-field label="Dni" readonly :value="this.dni">
              </v-text-field>
            </v-col>
            <v-col cols="3">
              <v-text-field label="Phone" readonly :value="this.phone">
              </v-text-field>
            </v-col>
            <v-col cols="3">
              <v-text-field label="Name" readonly :value="this.name">
              </v-text-field>
            </v-col>
            <v-col cols="3">
              <v-text-field label="Last Name" readonly :value="this.lastName">
              </v-text-field>
            </v-col>
            <v-col cols="4">
              <v-text-field label="User" readonly :value="this.user">
              </v-text-field>
            </v-col>
            <v-col cols="4">
              <v-text-field label="Email" readonly :value="this.email">
              </v-text-field>
            </v-col>
        ...
        <v-card>
          ...
          <v-card-text>
            <v-container>
              <v-row>
                <v-col cols="12">
                  <v-text-field label="user" v-model="_user" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="password" v-model="_password" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="dni" v-model="_dni" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="phone" v-model="_phone" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="email" v-model="_email" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="name" v-model="_name" required></v-text-field>
                </v-col>
                <v-col cols="12">
                  <v-text-field label="lastName" v-model="_lastName" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="urlToBackgroundImage" v-model="_urlToBackgroundImage" required></v-text-field>
                </v-col>

                <v-col cols="12">
                  <v-text-field label="urlToUserProfileImage" v-model="_urlToUserProfileImage" required></v-text-field>
                </v-col>
              </v-row>
            </v-container>
...
export default {
  ...
  methods: {
    async retrieveUsers() { 
      ...
      await UsersService.getUsersById(localStorage.getItem("user")).then(
        async (response) => {
